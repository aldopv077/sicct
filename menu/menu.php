		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						<li>
							<a href="home.php"><i class="fas fa-store-alt fa-fw"></i> &nbsp; Inicio</a>
						</li>

						<li>
							<a href="clientes/cliente-lista.php"><i class="fas fa-users fa-fw"></i> &nbsp; clientes</a>
						</li>
						<li>
							<a href="#" class="nav-btn-submenu"><i class="fas fa-pallet fa-fw"></i> &nbsp; Corte <i class="fas fa-chevron-down"></i></a>
							<ul>
								<li>
						...
						<li>
							<a href="#" class="nav-btn-submenu"><i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Talleres <i class="fas fa-chevron-down"></i></a>
							<ul>
								<li>
						...
						<li>
							<a href="#" class="nav-btn-submenu"><i class="fas  fa-user-secret fa-fw"></i> &nbsp; Empaque <i class="fas fa-chevron-down"></i></a>
							<ul>
								<li>

<nav class="full-box navbar-info">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="<?php echo base_url('ProduccionInt/index');?>"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO AVANCE</a>
					</li>
					<li>
						<a href="<?php echo base_url('ProduccionInt/lista');?>"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR AVANCE</a>
					</li>
				</ul>	
			</div>
			...
			<!-- Content -->
			<div class="container-fluid">
				<form name="FrmBuscarUsuario" class="form-neon" action="<?php echo base_url('ProduccionInt/buscar')?>" method="post">
					<div class="container-fluid">
            ...
            <?php if(isset($empleados)){?>
				...
				<form name="FrmAvance" Id="FrmAvance" action="<?php echo base_url('ProduccionInt/Avance')?>" method="post">
                                <div class="col-12 col-md-6">
									<div class="form-group">
									    <label for="cmbSesiones" class="bmd-label-floating">* Sesión</label>
										<select class="form-control" name="cmbSesiones" id="cmbSesiones">
										    <option value="0">Seleccione una opción</option>
											<?php 
                                                foreach ($sesiones as $value){
                                            ?>
                                                <option value="<?php echo $value->IdSesion?>"><?php echo $value->IdSesion?></option>
                                            <?php        
                                                }
                                            ?>
										</select>
                                ...
                                <input type="hidden" name="txtOperacion" value="<?php echo $operacion?>">
						...
						<tbody>
                            ...
                            ?>
							        <tr class="text-center" >
                                        ...
                                        <td><input type="hidden" name="txtIdEmpleado[]" value="<?php echo $value->IdEmpleado?>"></td> 

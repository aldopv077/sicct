							...
							<tbody>
								...
								?>
										...
										<!-- <th><?php //echo $value->Clasificacion?></th> -->
											...
											<td>
												<a href="<?php echo base_url('Sesiones/historial/').$value->IdProducto.'/'.$value->Id; ?>" class="btn btn-warningn">
											...
											<td>
												<a onclick="if(confirma() === false) return false" href="<?php echo base_url('Sesiones/eliminar/').$value->IdProducto.'/'.$value->Id;?>" class="btn btn-warning"> <i class="fas fa-check"></i>  </a>
											</td>
											<td>
											<?php 
												if($value->Estado == 'Iniciado' || $value->Estado == 'En Proceso'){

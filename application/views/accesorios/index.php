			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="<?php echo base_url('Accesorios/index'); ?>"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ACCESORIO</a>
					</li>
					<li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="<?php echo base_url('Accesorios/ingresar')?>" method="post" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="txtAccesorio" id="txtAccesorio" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="txtMedida" class="bmd-label-floating">* Medida</label>
										<input type="text" class="form-control" name="txtMedida" id="txtMedida" maxlength="40">
									</div>
								</div>
							</div>							
						</div>
